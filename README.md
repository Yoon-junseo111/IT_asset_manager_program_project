...
#### 2. 대여 기능을 통한 상태 변경 관리

`대여 가능` 또는 `수리 중`인 자산을

수정 기능을 통해 직접 `사용 중` 상태로 변경할 수 없도록 구현했습니다.

`사용 중` 상태는 반드시 자산의 `대여` 기능을 통해 변경되도록 제한하여

대여자, 대여 날짜, 반납 예정일 등의 정보가 함께 관리되도록 개선했습니다.

![사용 중 상태 직접 변경 제한](result/day6_1.png)
